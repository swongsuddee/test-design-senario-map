...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-302',         cls: 'blue'  },
...
export default function PP302Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-302</span> · Your Vibes — Core Quiz</h2>
        <p>Requirement document for Your Vibes — Core Quiz. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-302" />
      </section>
    </>
  );
}
