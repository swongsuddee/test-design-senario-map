...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-90',         cls: 'blue'  },
...
export default function PP90Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-90</span> · Register Flow (Mobile Onboarding)</h2>
        <p>Requirement document for Register Flow (Mobile Onboarding). Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-90" />
      </section>
    </>
  );
}
