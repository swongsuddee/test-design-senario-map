...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-350',         cls: 'blue'  },
...
export default function PP350Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-350</span> · Search Event</h2>
        <p>Requirement document for Search Event. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-350" />
      </section>
    </>
  );
}
