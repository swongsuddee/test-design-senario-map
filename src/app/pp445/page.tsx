...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-445',         cls: 'blue'  },
...
export default function PP445Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-445</span> · Comment on Running Event</h2>
        <p>Requirement document for Comment on Running Event. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-445" />
      </section>
    </>
  );
}
