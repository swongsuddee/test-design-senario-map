...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-226',         cls: 'blue'  },
...
export default function PP226Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-226</span> · Event Detail — Organizer Info</h2>
        <p>Requirement document for Event Detail — Organizer Info. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-226" />
      </section>
    </>
  );
}
