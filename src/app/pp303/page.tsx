...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-303',         cls: 'blue'  },
...
export default function PP303Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-303</span> · Your Vibes — Results</h2>
        <p>Requirement document for Your Vibes — Results. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-303" />
      </section>
    </>
  );
}
