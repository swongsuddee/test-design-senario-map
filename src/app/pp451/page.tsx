...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-451',         cls: 'blue'  },
...
export default function PP451Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-451</span> · Feeds Poppa</h2>
        <p>Requirement document for Feeds Poppa. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-451" />
      </section>
    </>
  );
}
