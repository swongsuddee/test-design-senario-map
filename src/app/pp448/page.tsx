...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-448',         cls: 'blue'  },
...
export default function PP448Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-448</span> · Explore Post (M-App)</h2>
        <p>Requirement document for Explore Post (M-App). Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-448" />
      </section>
    </>
  );
}
