...
export default function PP304Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-304</span> · Your Vibes — Profile</h2>
        <p>Requirement document for Your Vibes — Profile. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-304" />
      </section>
    </>
  );
}
