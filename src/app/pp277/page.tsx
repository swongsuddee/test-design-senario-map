...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-277',         cls: 'blue'  },
...
export default function PP277Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-277</span> · BO Report</h2>
        <p>Requirement document for BO Report. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-277" />
      </section>
    </>
  );
}
