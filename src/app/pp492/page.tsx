...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-492',         cls: 'blue'  },
...
export default function PP492Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-492</span> · Edit Running Event (BO)</h2>
        <p>Requirement document for Edit Running Event (BO). Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-492" />
      </section>
    </>
  );
}
