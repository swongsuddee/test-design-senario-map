...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-342',         cls: 'blue'  },
...
export default function PP342Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-342</span> · Story Poppa</h2>
        <p>Requirement document for Story Poppa. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-342" />
      </section>
    </>
  );
}
