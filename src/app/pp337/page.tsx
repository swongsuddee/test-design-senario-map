...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-337',         cls: 'blue'  },
...
export default function PP337Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-337</span> · Explore Post (สร้างโพสต์)</h2>
        <p>Requirement document for Explore Post (สร้างโพสต์). Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-337" />
      </section>
    </>
  );
}
