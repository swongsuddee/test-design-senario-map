...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-210',         cls: 'blue'  },
...
export default function PP210Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-210</span> · Interest Statistic Search</h2>
        <p>Requirement document for Interest Statistic Search. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-210" />
      </section>
    </>
  );
}
