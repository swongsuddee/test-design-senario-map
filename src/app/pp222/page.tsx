...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-222',         cls: 'blue'  },
...
export default function PP222Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-222</span> · Button Status — Running Registration</h2>
        <p>Requirement document for Button Status — Running Registration. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-222" />
      </section>
    </>
  );
}
