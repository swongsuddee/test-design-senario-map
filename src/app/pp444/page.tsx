...
const META_CARDS = [
  { label: 'Jira Story', value: 'PP-444',         cls: 'blue'  },
...
export default function PP444Page() {
  return (
    <>
      <div className="hero" id="hero">
        <div className="hero-badge">Draft · POPPA Story</div>
        <h2><span>PP-444</span> · Report Comment</h2>
        <p>Requirement document for Report Comment. Test design and flow diagrams will be added when development is complete.</p>
      ...
      <section className="section" id="requirements">
        <RequirementSection story="PP-444" />
      </section>
    </>
  );
}
